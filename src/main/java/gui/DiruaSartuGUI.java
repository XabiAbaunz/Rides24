...
public class DiruaSartuGUI extends JFrame {
	...
	private JButton btnExit = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DiruaSartuGUI.exit"));
	...
	public DiruaSartuGUI(User u) {
		...
		btnSartuAtera.setBounds(132, 208, 103, 31);
		...
		btnExit.setBounds(329, 233, 97, 31);
