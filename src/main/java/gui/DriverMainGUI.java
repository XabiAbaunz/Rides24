...
public class DriverMainGUI extends JFrame {
	...
	private final JButton btnLogOut = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DriverMainGUI.LogOut")); //$NON-NLS-1$ //$NON-NLS-2$
	/**
	...
	public DriverMainGUI(Driver d) {
		...
		btnLogOut.setBounds(341, 243, 85, 21);
		contentPane.add(btnLogOut);
	}
